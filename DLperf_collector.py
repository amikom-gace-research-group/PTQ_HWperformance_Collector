...
def evaluate(model_path: str, max_batch_size, batch_size_step, passwd):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--passwd', help='system password for clear cache', required=True)
    args = parser.parse_args()

    st = time.time()
    worker = evaluate(args.model_path, int(args.max_batch_size), int(args.batch_size_step), args.passwd)
