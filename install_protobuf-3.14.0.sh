...
echo "** Download protobuf-3.14.0 sources"
cd $folder
if [ ! -f protobuf-python-3.14.0.zip ]; then
  wget https://github.com/protocolbuffers/protobuf/releases/download/v3.14.0/protobuf-python-3.14.0.zip
fi
if [ ! -f protoc-3.14.0-linux-aarch_64.zip ]; then
...
unzip protoc-3.14.0-linux-aarch_64.zip -d protoc-3.14.0
sudo cp protoc-3.14.0/bin/protoc /usr/local/bin/protoc

echo "** Build and install protobuf-3.14.0 libraries"
...
echo "** Build protobuf-3.14.0 successfully"